        ...
        <div class="form-group">
           ...
           <select name="order" class="form-control">
                           ...
                           @foreach($erporderitems as $erporderitem)
                            <option value="{{$erporderitem->erporder_id}}"<?= ($payment->erporder_id==$erporderitem->erporder_id)?'selected="selected"':''; ?>> {{$erporderitem->item->name}}</option>
                           @endforeach
                        </select>
        </div>
